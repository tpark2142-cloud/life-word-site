...
const TOPIC_VERSE_NOTE_KO = {
  '1 Corinthians 10:13':'하나님은 감당하지 못할 시험을 허락하지 않으시고 피할 길도 주신다는 뜻입니다.',
  '1 Corinthians 13:4':'사랑은 참고 친절하며 자기중심적이지 않은 성품이라는 뜻입니다.',
  '1 Corinthians 6:19':'우리의 몸이 성령의 전이므로 거룩하게 돌보아야 한다는 뜻입니다.',
  '1 John 1:9':'죄를 자백할 때 하나님이 신실하게 용서하시고 깨끗하게 하신다는 뜻입니다.',
  '1 John 4:19':'우리가 사랑할 수 있는 이유는 하나님이 먼저 우리를 사랑하셨기 때문입니다.',
  '1 Peter 1:15':'우리를 부르신 하나님이 거룩하시니 삶 전체가 거룩함을 향해야 한다는 뜻입니다.',
  '1 Peter 1:3':'하나님의 긍휼로 그리스도의 부활을 통해 산 소망을 주셨다는 뜻입니다.',
  '1 Peter 3:15':'마음에 그리스도를 주로 모시고 소망의 이유를 온유하게 전하라는 뜻입니다.',
  '1 Peter 5:7':'모든 염려를 하나님께 맡길 수 있는 이유는 그분이 우리를 돌보시기 때문입니다.',
  '1 Samuel 15:22':'하나님은 제사보다 순종을 더 기뻐하신다는 뜻입니다.',
  '1 Thessalonians 5:17':'기도는 멈추지 않는 믿음의 호흡이라는 뜻입니다.',
  '1 Thessalonians 5:18':'모든 형편 속에서도 감사하며 하나님의 뜻을 바라보라는 뜻입니다.',
  '1 Timothy 6:6':'경건함과 자족이 함께할 때 큰 유익이 있다는 뜻입니다.',
  '2 Corinthians 1:3-4':'하나님이 우리를 위로하시고 그 위로로 다른 이도 위로하게 하신다는 뜻입니다.',
  '2 Corinthians 12:9':'하나님의 은혜는 충분하며 우리의 약함 속에서 그분의 능력이 드러난다는 뜻입니다.',
  '2 Corinthians 5:17':'그리스도 안에 있는 사람은 새롭게 된 피조물이라는 뜻입니다.',
  '2 Corinthians 5:7':'보이는 상황보다 하나님을 믿는 믿음으로 걸어가야 한다는 뜻입니다.',
  '2 Timothy 1:7':'하나님은 두려움이 아니라 능력과 사랑과 절제의 마음을 주신다는 뜻입니다.',
  'Colossians 3:13':'주님이 용서하신 것처럼 서로 용납하고 용서하라는 뜻입니다.',
  'Colossians 3:15':'그리스도의 평강이 마음을 다스리게 하고 감사하라는 뜻입니다.',
  'Colossians 3:23':'무슨 일을 하든 사람보다 주님께 하듯 성실하게 행하라는 뜻입니다.',
  'Ecclesiastes 4:9':'두 사람이 함께할 때 더 큰 유익과 도움을 얻는다는 뜻입니다.',
  'Ephesians 2:10':'우리는 하나님이 준비하신 선한 일을 위해 지음받은 존재라는 뜻입니다.',
  'Ephesians 2:8':'구원은 우리의 공로가 아니라 하나님의 은혜로 받는 선물이라는 뜻입니다.',
  'Ephesians 4:26':'분노가 오래 머물러 죄가 되지 않도록 빨리 다루라는 뜻입니다.',
  'Ephesians 4:32':'그리스도께서 용서하신 것처럼 서로 친절히 용서하라는 뜻입니다.',
  'Ephesians 5:25':'부부의 사랑은 그리스도의 희생적 사랑을 닮아야 한다는 뜻입니다.',
  'Ephesians 6:4':'자녀를 화나게 하기보다 주님의 교훈과 훈계로 양육하라는 뜻입니다.',
  'Galatians 5:22-23':'성령의 열매는 하나님의 성품이 삶 속에 자라나는 모습이라는 뜻입니다.',
  'Galatians 6:2':'서로의 짐을 함께 지는 것이 그리스도의 사랑을 따르는 길이라는 뜻입니다.',
  'Hebrews 11:1':'믿음은 아직 보이지 않아도 하나님의 약속을 붙드는 확신이라는 뜻입니다.',
  'Hebrews 12:14':'모든 사람과 화평을 이루고 거룩함을 따르라는 뜻입니다.',
  'Hebrews 13:5':'하나님이 결코 떠나지 않으시니 가진 것으로 만족하라는 뜻입니다.',
  'Isaiah 26:3':'하나님을 신뢰하는 마음에 완전한 평강을 주신다는 뜻입니다.',
  'Isaiah 40:31':'주님을 기다리는 자에게 새 힘을 주셔서 다시 일어서게 하신다는 뜻입니다.',
  'Isaiah 41:10':'두려워하지 말고 하나님이 함께하시며 힘 주신다는 약속입니다.',
  'Isaiah 46:4':'인생의 끝까지 하나님이 품으시고 붙드신다는 뜻입니다.',
  'James 1:19':'듣기는 속히 하고 말하기와 성내기는 더디 하라는 뜻입니다.',
  'James 1:2':'시련은 믿음을 연단하여 인내를 이루는 통로가 될 수 있다는 뜻입니다.',
  'James 1:22':'말씀을 듣기만 하지 말고 삶으로 실천하라는 뜻입니다.',
  'James 1:5':'지혜가 부족할 때 후히 주시는 하나님께 구하라는 뜻입니다.',
  'James 4:8':'하나님께 가까이 나아가면 하나님도 우리에게 가까이 오신다는 뜻입니다.',
  'James 5:16':'서로 죄를 고백하고 기도할 때 치유와 회복이 임할 수 있다는 뜻입니다.',
  'Jeremiah 29:11':'하나님은 재앙이 아니라 평안과 소망의 계획을 가지신다는 뜻입니다.',
  'John 1:16':'그리스도의 충만함 안에서 우리가 은혜 위에 은혜를 받는다는 뜻입니다.',
  'John 11:25':'예수님은 부활과 생명이시며 그를 믿는 자에게 영원한 소망이 있다는 뜻입니다.',
  'John 11:35':'예수님의 눈물은 우리의 슬픔을 함께 아시는 사랑을 보여 줍니다.',
  'John 14:15':'주님을 사랑하는 마음은 그의 말씀에 순종하는 삶으로 나타난다는 뜻입니다.',
  'John 14:2':'주님이 우리를 위해 영원한 거처를 예비하신다는 뜻입니다.',
  'John 14:26':'성령께서 말씀을 생각나게 하시고 우리를 가르치신다는 뜻입니다.',
  'John 14:27':'예수님이 세상이 줄 수 없는 평안을 주신다는 뜻입니다.',
  'John 15:11':'주님의 기쁨이 우리 안에 머물러 충만한 기쁨을 누리게 하신다는 뜻입니다.',
  'John 3:16':'하나님이 세상을 사랑하셔서 독생자를 주시고 믿는 자에게 영생을 주신다는 뜻입니다.',
  'John 4:24':'하나님께 드리는 참된 예배는 영과 진리로 드려야 한다는 뜻입니다.',
  'John 8:36':'예수님이 주시는 자유는 죄와 묶임에서 참으로 벗어나게 한다는 뜻입니다.',
  'Joshua 1:9':'강하고 담대하라 하시며 하나님이 함께하신다는 약속입니다.',
  'Lamentations 3:22-23':'하나님의 인자와 긍휼이 매일 새롭다는 뜻입니다.',
  'Mark 9:24':'믿음이 부족한 자리에서도 주님께 도움을 구할 수 있다는 뜻입니다.',
  'Matthew 11:28':'무거운 마음을 주님께 가지고 가면 참된 쉼을 주신다는 뜻입니다.',
  'Matthew 25:40':'가장 작은 이에게 한 섬김이 곧 주님께 드린 섬김이라는 뜻입니다.',
  'Matthew 28:19':'모든 민족에게 복음을 전하고 제자를 삼으라는 주님의 명령입니다.',
  'Matthew 28:20':'주님이 세상 끝날까지 우리와 함께하신다는 약속입니다.',
  'Matthew 5:4':'슬퍼하는 자를 하나님이 친히 위로하신다는 뜻입니다.',
  'Matthew 6:33':'먼저 하나님의 나라와 의를 구할 때 필요한 것을 더하신다는 뜻입니다.',
  'Matthew 6:34':'내일 염려보다 오늘 주시는 은혜를 신뢰하라는 뜻입니다.',
  'Philippians 1:21':'그리스도를 위해 사는 것이 참된 유익이며 죽음도 주 안에 소망이 될 수 있다는 뜻입니다.',
  'Philippians 3:20':'우리의 참된 시민권은 하늘에 있으며 그곳에서 구주를 기다린다는 뜻입니다.',
  'Philippians 4:11':'어떤 형편에서도 자족을 배우는 것이 믿음의 성숙이라는 뜻입니다.',
  'Philippians 4:19':'하나님이 그리스도 안에서 필요한 모든 것을 채우신다는 뜻입니다.',
  'Philippians 4:4':'주님 안에서 언제나 기뻐하라는 뜻입니다.',
  'Philippians 4:6':'염려를 붙들기보다 기도와 감사로 하나님께 맡기라는 뜻입니다.',
  'Philippians 4:7':'하나님의 평강이 우리의 마음과 생각을 지켜 주신다는 뜻입니다.',
  'Proverbs 15:1':'부드러운 대답은 분노를 누그러뜨린다는 뜻입니다.',
  'Proverbs 16:3':'하는 일을 주님께 맡길 때 계획을 세워 주신다는 뜻입니다.',
  'Proverbs 16:31':'백발은 의로운 삶에서 오는 아름다운 영광이라는 뜻입니다.',
  'Proverbs 18:22':'배우자를 얻는 것은 주님께 받은 좋은 선물이라는 뜻입니다.',
  'Proverbs 22:6':'아이를 바른 길로 인도하면 평생 그 길을 떠나지 않도록 돕는다는 뜻입니다.',
  'Proverbs 24:16':'의인은 넘어져도 다시 일어설 수 있다는 뜻입니다.',
  'Proverbs 3:5-6':'자기 명철보다 하나님을 신뢰할 때 길을 인도하신다는 뜻입니다.',
  'Psalm 100:4':'감사와 찬양으로 하나님의 문에 들어가라는 뜻입니다.',
  'Psalm 103:12':'하나님이 죄를 멀리 옮기시듯 완전히 용서하신다는 뜻입니다.',
  'Psalm 119:105':'하나님의 말씀은 우리의 발걸음을 비추는 빛이라는 뜻입니다.',
  'Psalm 127:2':'사랑하시는 자에게 안식과 쉼을 주신다는 뜻입니다.',
  'Psalm 127:3':'자녀는 하나님께서 주시는 귀한 선물이라는 뜻입니다.',
  'Psalm 139:7':'하나님의 영과 임재를 피할 곳이 없을 만큼 늘 함께하신다는 뜻입니다.',
  'Psalm 145:18':'진실하게 부르는 모든 이에게 하나님이 가까이 계신다는 뜻입니다.',
  'Psalm 147:3':'하나님이 상한 마음을 싸매시고 치유하신다는 뜻입니다.',
  'Psalm 16:11':'하나님 안에 생명의 길과 참된 기쁨이 있다는 뜻입니다.',
  'Psalm 23:1':'주님이 목자이시므로 참된 필요를 채워 주신다는 뜻입니다.',
  'Psalm 23:4':'어두운 골짜기에서도 하나님이 함께하시니 두려워하지 말라는 뜻입니다.',
  'Psalm 34:18':'하나님은 마음이 상한 자에게 가까이 오신다는 뜻입니다.',
  'Psalm 37:24':'넘어질 때에도 하나님이 손으로 붙드셔서 완전히 버려지지 않는다는 뜻입니다.',
  'Psalm 42:11':'낙심한 마음에도 하나님께 소망을 두고 다시 찬양하라는 뜻입니다.',
  'Psalm 4:8':'하나님 안에서 평안히 눕고 잠들 수 있다는 뜻입니다.',
  'Psalm 95:6':'우리를 지으신 주님 앞에 경배하고 무릎 꿇으라는 뜻입니다.',
  'Revelation 21:4':'하나님이 눈물과 죽음과 고통을 없애시는 영원한 날이 온다는 뜻입니다.',
  'Romans 1:16':'복음은 믿는 자를 구원하시는 하나님의 능력이므로 부끄러워하지 말라는 뜻입니다.',
  'Romans 10:9':'예수님을 주로 믿고 고백하는 자에게 구원이 주어진다는 뜻입니다.',
  'Romans 12:1':'우리 삶 전체를 하나님께 드리는 것이 참된 예배라는 뜻입니다.',
  'Romans 12:18':'할 수 있는 한 모든 사람과 평화롭게 지내라는 뜻입니다.',
  'Romans 12:2':'세상의 방식보다 마음을 새롭게 하여 하나님의 뜻을 분별하라는 뜻입니다.',
  'Romans 15:13':'소망의 하나님이 기쁨과 평강으로 우리를 충만하게 하신다는 뜻입니다.',
  'Romans 6:14':'그리스도 안에서 죄가 더 이상 우리를 지배하지 못한다는 뜻입니다.',
  'Romans 8:18':'현재의 고난은 장차 나타날 영광과 비교할 수 없다는 뜻입니다.',
  'Romans 8:28':'하나님을 사랑하는 자들에게 모든 것이 합하여 선을 이룬다는 뜻입니다.'
};
...
function injectTopicVerseKoreanNotes(){
  document.querySelectorAll('.topic-panel .dv-content').forEach(content=>{
    ...
    noteEl.textContent='í•œê¸€ í•µì‹¬ ëœ»: '+repairMojibake(note);
